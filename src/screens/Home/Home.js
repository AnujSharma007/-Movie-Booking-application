              ...
              <span className='second-header'>Upcoming Movies</span>
                ...
                <div className='homepage'>
                 ...
                 <FormControl fullWidth>
                     ...
                     <Select>
                        {
                            this.moviesData.map((genre)=>{
                                return <MenuItem value={genre.genres}>{genre.genres}</MenuItem>
                            })
                        }
                    </Select>
                    <br></br><br></br>
                    <Select >
                        {
                            ...
                            this.moviesData.map((movie)=>{
                                debugger;
                                return <MenuItem  value={movie.artists.first_name}>{movie.artists.first_name}</MenuItem>
                            })
                        }
                    </Select><br></br><br></br>
