...
import { Button, FormControl, ImageList, Input, InputLabel, Link, MenuItem, Select, Switch, TextField } from '@material-ui/core';
...
class Home extends Component {
    ...
    render() { 
        ...
        return (<div className='headmoviecontainer'>
            <Header></Header>
              <span className='second-header'>Upcoming Movies</span>
                ...
                <div className='upcomingmovies'>
                {
                    this.moviesData.map((movie)=>{
                        ...
                        return <div  key={movie.id}>
                            <img className='upcomingmovieimg' src={movie.poster_url}></img>
                        </div>
                    })
                }
                ...
                <div className='homepage'>
                 ...
                 <div className='movieimgcard'>
                 {
                    this.moviesData.map((movie)=>{

                        return <div  key={movie.id}> 
                        <div className='divv'>
                        <img className='upcomingmovieimg' onClick={showDetail} src={movie.poster_url}></img>
                 ...
                 <FormControl fullWidth>
                     <span className='filterheading'>FIND MOVIES BY:</span> <br></br><br></br><br></br>
                     
                     <Input type='text' placeholder='Movie Name'></Input><br></br><br></br>
                     
                     <Select>

                        {
                            this.genres.map((genre)=>{
                                return <MenuItem type="checkbox" value={genre.name}>{genre.name}</MenuItem>
                            })
                        }
                    </Select>
                    <br></br><br></br>
                    <Select >
                        {
                            ...
                            this.artists.map((artist)=>{
                                debugger;
                                return <MenuItem value={artist.first_name}>{artist.first_name} {artist.last_name}</MenuItem>
                            })
                        }
                    </Select><br></br><br></br>
